...
public abstract class SV {
    ...
    public SV(String s, Date ns, double d){
        hoTen = s;
        ngaySinh = ns;
        if(this.ngaySinh.getYear() <= 1980){
            dtb = d +0.5;
        }
        else dtb = d;
    }
    ...
    public void hienThi(){
        System.out.print("Sinh vien " + hoTen + " sinh ngay " + ngaySinh.getDate() + "/" + ngaySinh.getMonth() + "/" + ngaySinh.getYear() + " co diemtb = "+dtb);
    }
    public abstract boolean duocTN();
    public abstract boolean loaiSV(String s);


}
// sinh vien co lop de xep ho ten ngay thang
