...
public class EmployeeFrame extends javax.swing.JFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Pattern patternGmail = Pattern.compile("^[A-Z0-9._%+-]+@[A-Z0-9.-]+\\.[A-Z]{1,20}$", Pattern.CASE_INSENSITIVE);
        Pattern patternPassWord = Pattern.compile("((?=.*[a-z])(?=.*[A-Z]).{6,20})");
        ...
        else if(matcherGmail.matches() == false ){
            JOptionPane.showMessageDialog(this,"Gmail phải chữ '@,.com' có độ dài từ 1 đến 20 kí tự");
        }
        else if(matcherPassword.matches() == false ){
            JOptionPane.showMessageDialog(this,"Password: Phải chứa ít nhất 1 ký tự số từ 0 – 9\n" +
                    "\n" +
