...
public class Login {
    ...
    static JButton btnNewButton = new JButton("Submit");
    ...
    public Login(){
        ...
        frame.getContentPane().add(btnNewButton); //  nut Submit co chuc nang la dang nhap ket noi database tren php de lay ten username voi password va mo cua so den trang QuanLy
